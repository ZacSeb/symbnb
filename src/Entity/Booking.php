...
class Booking
{
     ...
     * @Assert\GreaterThan(propertyPath="startDate", message="La date de départ doit être postérieure à celle de votre arrivée !")
     */
    private $endDate;
    ...
    public function prePersit() {
        ...
        if(empty($this->amount)) {
            // prix de l'annonce * nombre de jour (nuit)
    ...
    public function isBookableDates() {
        ...
        //$days et $notAvailableDays sont des tableaux qui contiennent des chaines de carctères de mes journées prets à comparer
    ...
    public function getDuration() {
        // fonction qui calcule la différence entre le jour arrivée et jour de départ
